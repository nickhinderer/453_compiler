...
//        test();
    ...
    public static void test() {
        final String[] files = {"BinaryTree.opt.vapor", "LinearSearch.opt.vapor", "QuickSort.opt.vapor", "BinaryTree.vapor", "LinearSearch.vapor", "QuickSort.vapor", "BubbleSort.opt.vapor", "LinkedList.opt.vapor", "ShortCircuit.opt.vapor", "BubbleSort.vapor", "LinkedList.vapor", "ShortCircuit.vapor", "Factorial.opt.vapor", "MoreThan4.opt.vapor", "TreeVisitor.opt.vapor", "Factorial.vapor", "MoreThan4.vapor", "TreeVisitor.vapor"};
